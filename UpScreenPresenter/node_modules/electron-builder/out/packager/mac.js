...
function createApp(opts, appOutDir, initializeApp) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const protocols = util_1.asArray(packager.devMetadata.build.protocols).concat(util_1.asArray(packager.platformSpecificBuildOptions.protocols));
        ...
        util_1.use(appInfo.category, it => appPlist.LSApplicationCategoryType = it);
